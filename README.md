...
Diagrama de arquitectura: [`docs/diagrams/arquitecturaVoxChain.jpeg`](docs/diagrams/arquitecturaVoxChain.jpeg).
La fuente de verdad del dominio (reglas de gobierno) es [`AGENT.md`](AGENT.md).
